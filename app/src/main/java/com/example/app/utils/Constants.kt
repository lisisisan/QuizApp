...
object Constants {
    ...
    fun getTranslateQuestions(): MutableList<TranslateQuestion> {
        val questions = mutableListOf<TranslateQuestion>()

        questions.add(TranslateQuestion("Cat", "Кот"))
        questions.add(TranslateQuestion("Dog", "Собака"))
        questions.add(TranslateQuestion("Bird", "Птица"))
        questions.add(TranslateQuestion("Fish", "Рыба"))
        questions.add(TranslateQuestion("Horse", "Лошадь"))
